...
const multiSelectVariants = cva("m-1 transition-all duration-300 ease-in-out", {
  variants: {
    ...
    badgeAnimation: {
      bounce: "hover:-translate-y-1 hover:scale-105",
        ...
        >
          ...
          <PopoverTrigger asChild>
            <Button
              ...
              className={cn(
                "flex p-1 rounded-md border !min-h-10 items-center justify-between hover:bg-white [&_svg]:pointer-events-auto bg-white text-[#1e1d19] border-[#03303e66] hover:border-[#03303e] !h-auto",
                autoSize ? "w-auto" : "w-full",
                responsiveSettings.compactMode && "min-h-10 text-sm",
                screenSize === "mobile" && "min-h-12 text-base",
                disabled && "opacity-50 cursor-not-allowed",
                selectedValues.length === 0 && "!h-10",
                className,
              )}
              style={{
                ...widthConstraints,
                ...
                <div className="flex justify-between items-center w-full">
                  ...
                  >
                        ...
                        return (
                          <Badge
                            ...
                            className={cn(
                              ...
                              "rounded-sm border-gray-400 p-1 bg-white"
                            )}
                            style={{
                              ...badgeStyle,
                              animationDuration: `${
                          ...
                          >
                            ...
                            <div
                              ...
                              className="ml-2 h-4 w-4 cursor-pointer hover:bg-white/20 rounded-sm -m-0.5 focus:outline-none focus:ring-1 focus:ring-white/50 group"
                            >
                              <XCircle
                                className={cn(
                                  "h-3 w-3 group-hover:text-red-500",
                                  responsiveSettings.compactMode &&
                                    "h-2.5 w-2.5"
                                )}
                              />
                    ...
                    {selectedValues.length > responsiveSettings.maxCount && (
                      <Badge
                        className={cn(
                          "ml-2 h-auto w-fit border-[rgb(189,189,189)] cursor-pointer hover:bg-white/20 rounded-sm -m-0.5 focus:outline-none focus:ring-1 focus:ring-white/50 group",
                          getBadgeAnimationClass(),
                          multiSelectVariants({ variant }),
                          responsiveSettings.compactMode &&
                            "text-xs px-1.5 py-0.5",
          ...
          <PopoverContent
            ...
            className={cn(
              "w-auto p-0 bg-white text-black",
                ...
                {!hideSelectAll && !searchValue && (
                  <CommandGroup className="pb-0">
                    <CommandItem
                      ...
                      className="cursor-pointer hover:bg-[#03303e]/60 hover:text-white"
                    >
                      <div
                        className={cn(
                      ...
                      {group.options.map((option) => {
                        ...
                        return (
                          <CommandItem
                            ...
                            className={cn(
                              "cursor-pointer hover:bg-[#03303e]/60 hover:text-white",
                ...
                <CommandGroup>
                  <div className="flex items-center justify-between">
                    {selectedValues.length > 0 && (
                      <>
                        <CommandItem
                          ...
                          className="flex-1 justify-center cursor-pointer hover:bg-[#03303e]/60 hover:text-white"
                        >
                          Clear
                        </CommandItem>
                        <Separator
                    ...
                    <CommandItem
                      ...
                      className="flex-1 justify-center cursor-pointer max-w-full hover:bg-[#03303e]/60 hover:text-white"
                    >
                      Close
                    </CommandItem>
                  </div>
